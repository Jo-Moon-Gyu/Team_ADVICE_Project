...
import com.example.adviser.databinding.ActivityMapUserPhBinding;
...
public class MapUserPhActivity extends AppCompatActivity implements MapView.POIItemEventListener {
    ...
    private ActivityMapUserPhBinding binding;
    private boolean isMapViewInitialized = false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityMapUserPhBinding.inflate(getLayoutInflater());
                    ...
                    binding.navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
                        ...
                        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                            if (item.getItemId() == R.id.home) {
                                Intent intent = new Intent(MapUserPhActivity.this, MainUserActivity.class);
                                ...
                                Intent intent = new Intent(MapUserPhActivity.this, MypageUserActivity.class);
                                startActivity(intent);
                                finish();
                                return true;
                            } else if (item.getItemId() == R.id.guides) {
                                // 이용 안내 이동
                                Intent intent = new Intent(MapUserPhActivity.this, AppGuideUserActivity.class);
                                startActivity(intent);
                                finish();
                                return true;
                                ...
                                editor.clear();
                                editor.apply();
                                Intent intent = new Intent(MapUserPhActivity.this, LoginActivity.class);
                                startActivity(intent);
                                finish();
                            }
        ...
        // 위치 권한 요청
        ActivityCompat.requestPermissions(MapUserPhActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
        ...
        fusedLocationClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    Toast.makeText(MapUserPhActivity.this, "위치 정보를 가져올 수 없습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void showKakaoMap() {
        ...
        if (!isMapViewInitialized) {
            if (mapView != null) {
                ...
                mapView = new MapView(MapUserPhActivity.this);
                Log.d("kkkk", "5");
            } else {
                mapView = new MapView(MapUserPhActivity.this);
            }
    ...
    private MapPOIItem createHospitalMarker(Document document) {
        ...
        hospitalMarker.setCustomImageBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.pharmacy2));
