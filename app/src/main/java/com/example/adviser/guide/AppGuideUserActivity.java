...
import com.example.adviser.databinding.ActivityAppGuideUserBinding;
import com.example.adviser.kakaomap.MapUserActivity;
import com.example.adviser.vo.User;
import com.google.android.material.navigation.NavigationView;
import com.google.gson.Gson;

public class AppGuideUserActivity extends AppCompatActivity {

    ActivityAppGuideUserBinding binding;
    private DrawerLayout drawerLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAppGuideUserBinding.inflate(getLayoutInflater());
        ...
        // 유저 정보를 레이아웃에 표시한다.
        binding.nick.setText(user.getUserName() + "님");
        ...
        binding.navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.home) {
                    navigateTo(MainUserActivity.class);
                } else if (item.getItemId() == R.id.mypage) {
                    navigateTo(MypageUserActivity.class);
                } else if (item.getItemId() == R.id.map) {
                    navigateTo(MapUserActivity.class);
    ...
    private void navigateTo(Class<?> destinationActivity) {
        Intent intent = new Intent(AppGuideUserActivity.this, destinationActivity);
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent intent = new Intent(AppGuideUserActivity.this, MainUserActivity.class);
        startActivity(intent);
        finish(); // 현재 액티비티 종료
    }
