...
public class QuestionMedicVO implements Serializable {
    ...
    private transient Bitmap deep_img;
    ...
    public QuestionMedicVO(Bitmap questionImg, int req_idx, String user_email, String req_user_nick, String user_birthyear, String user_gender, String deep_result, Bitmap deep_img, String req_title, String req_content, String created_at, int ans_idx, String ans_user_email, String ans_user_name, String ans_content, String ans_file, String answered_at) {
    ...
    public Bitmap getDeep_img() {
        return deep_img;
    }

    public void setDeep_img(Bitmap deep_img) {
        this.deep_img = deep_img;
    }
